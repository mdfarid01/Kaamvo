...
export const TOOLS: Tool[] = [
  ...
  },
  {
    slug: "pdf-watermark",
    name: "Watermark PDF",
    description: "Stamp your own text across every page, at the opacity and angle you choose.",
    category: "PDF",
    status: "live",
    keywords: ["watermark", "stamp", "confidential", "draft", "copyright", "overlay", "diagonal"],
  },
  {
    slug: "pdf-page-numbers",
    name: "Add Page Numbers",
    description: "Number every page of a PDF, as 1, Page 1 or 1 of N.",
    category: "PDF",
    status: "live",
    keywords: [
      "page numbers",
  ...
  },
  {
    ...
    description: "Read and rewrite a PDF's title, author, subject and keywords.",
    category: "PDF",
    status: "live",
    keywords: [
      "metadata",
  ...
  },
  {
    ...
    description: "Put your own text over a photo — pick the corner, size, colour and opacity.",
    category: "Image",
    status: "live",
    keywords: [
      "watermark",
  ...
  },
  {
    ...
    description: "Fill in earnings and deductions and download a clean A4 payslip PDF.",
    category: "Generate",
    status: "live",
    keywords: [
      "payslip",
  ...
  },
  {
    ...
    description: "Write an employment offer letter and download it on your own letterhead.",
    category: "Generate",
    status: "live",
    keywords: [
      "offer letter",
  ...
  },
  {
    ...
    description: "Build a weekly timetable slot by slot and print it.",
    category: "Generate",
    status: "live",
    keywords: [
      "study plan",
  ...
  },
  {
    ...
    description: "Fill in a name and an event, and download a bordered landscape certificate PDF.",
    category: "Generate",
    status: "live",
    keywords: [
      "certificate",
  ...
  },
  {
    slug: "vcard-qr",
    name: "vCard QR Code",
    description: "Turn your contact details into a QR code that saves straight to a phone.",
    category: "Generate",
    status: "live",
    keywords: [
      "vcard",
  ...
  },
  {
    slug: "signature-pad",
    name: "Signature Pad",
    description: "Sign with a mouse, pen or finger and download a transparent PNG.",
    category: "Generate",
    status: "live",
    keywords: [
      "signature",
  ...
  },
  {
    slug: "random-picker",
    name: "Random Picker",
    description: "Pick a name at random from a list, or split the list into random teams.",
    category: "Everyday",
    status: "live",
    keywords: [
      "raffle",
